...
terraform {
  ...
  backend "azurerm" {
    resource_group_name   = "gopal-storage" #change it with your storage account rg name 
    storage_account_name  = "terraformstoragegopal" #change it with your storage account name
